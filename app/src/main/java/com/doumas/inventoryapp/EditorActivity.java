package com.doumas.inventoryapp;
...
import com.doumas.inventoryapp.data.ProductContract;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                // Create a click listener to handle the user confirms that changes should be discarded.
     ...
     * is not detected, yet entries have been made (e.g. typing using keyboard)
     */
